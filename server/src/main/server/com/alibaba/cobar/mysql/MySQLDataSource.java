...
public final class MySQLDataSource {
    ...
    private final MySQLDataNode node;	/* 上层data node */
    private final int index;					/* TODO 在data node中的数组中的下标 */
    private final String name;				/* datasource的名字 */
    private final DataSourceConfig config;	/* 配置*/
    private int activeCount;					/* 分配的连接数目 */
    private int idleCount;						/* 空闲的连接数目 */
    private final int size;						/* 配置的连接池大小 */
    private final Channel[] items;		/* 保存后端连接,多个 */
    private final ReentrantLock lock;
    private final ChannelFactory factory;		/* 创建后端连接 */
    private final MySQLHeartbeat heartbeat;	/* 心跳检测 */
    private final SQLRecorder sqlRecorder;	/* 记录慢请求 */
