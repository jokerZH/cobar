...
public class BlockingSession implements Session {
    ...
    private final ServerConnection source;		/* 客户端连接 */
    private final ConcurrentHashMap<RouteResultsetNode, Channel> target;	/* 对应后端的语句，连接 */
    private final SingleNodeExecutor singleNodeExecutor;		/* 结果只需要一个mysql处理的时候 */
    private final MultiNodeExecutor multiNodeExecutor;		/* 同时提交多个mysql的请求 */
    private final DefaultCommitExecutor commitExecutor;		/* 同时提交多个mysql的commit请求 */
