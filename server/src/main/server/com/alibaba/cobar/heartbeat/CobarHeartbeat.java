...
public class CobarHeartbeat {
    ...
    private final CobarNode node;	/* cobar实例 */
    private final AtomicBoolean isStop;					/* 是否停止检测心跳 */
    private final AtomicBoolean isChecking;			/* 是否正在检测心跳 */
    private final CobarDetectorFactory factory;	/* 创建心跳处理 */
    private final HeartbeatRecorder recorder;	/* 记录心跳 */
    private final ReentrantLock lock;					/* lock */
    private final int maxRetryCount;
    private int errorCount;
    private volatile int status;
    private CobarDetector detector;	/* 做实际的操作 */
    public final AtomicLong detectCount;	/* heartbeat包中的id */
