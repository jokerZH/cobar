...
public class MySQLHeartbeat {
    ...
    private final MySQLDataSource source;	/* 属于的datasourc哦*/
    private final AtomicBoolean isStop;
    private final AtomicBoolean isChecking;			/* TODO */
    private final MySQLDetectorFactory factory;
    private final HeartbeatRecorder recorder;		/* 统计信息 */
