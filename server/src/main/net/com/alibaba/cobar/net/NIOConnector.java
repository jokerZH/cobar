...
public final class NIOConnector extends Thread {
    ...
    private NIOProcessor[] processors;	/* 处理线程数组 */
    private int nextProcessor;					/* 用于分配processor */
    private long connectCount;					/* 当前已经建立的连接 */
