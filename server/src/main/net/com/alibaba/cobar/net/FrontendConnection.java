...
public abstract class FrontendConnection extends AbstractConnection {
    ...
    protected long id;
    protected String host;			/* 客户端ip */
    protected int port;					/* 客户端port */
    ...
    protected String schema;			/* dbName */
    protected NIOHandler handler;	/* 处理数据的handle */
    protected FrontendPrivileges privileges;	/* 用户名 密码判断检测 */
    protected FrontendQueryHandler queryHandler;	/* 处理QUERY请求 TODO */
    protected FrontendPrepareHandler prepareHandler;
    protected boolean isAccepted;				/* 连接是否建立 */
    protected boolean isAuthenticated;	/* 是否通过验证 */
