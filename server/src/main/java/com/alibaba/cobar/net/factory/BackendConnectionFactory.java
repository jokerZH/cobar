...
public abstract class BackendConnectionFactory {
    ...
    protected int socketRecvBuffer = 16 * 1024;		/* tcp接收缓存大小 */
    protected int socketSendBuffer = 8 * 1024;		/* tcp发送缓存大小 */
    protected int packetHeaderSize = 4;						/* 头部大小 */
    protected int maxPacketSize = 16 * 1024 * 1024;	/* 最大数据包大小 */
    protected int writeQueueCapcity = 8;					/* 用户写的bufferQueue中的大小 */
    protected long idleTimeout = 8 * 3600 * 1000L;/* 判定是否空闲的时间大小 */
    ...
    protected SocketChannel openSocketChannel() throws IOException {
		...
		/* 配置BackenConnection，发起连接操作，有connector完成 */
