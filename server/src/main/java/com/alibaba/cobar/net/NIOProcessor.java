...
public final class NIOProcessor {
    ...
    private final NIOReactor reactor;	/* 网络读写的处理线程  */
    private final BufferPool bufferPool;			/* byteBuffer的缓存,防止频繁的创建buffer */
    private final NameableExecutor handler;		/* 前端handle TODO */
    private final NameableExecutor executor;	/* 后端执行器 TODO */
    private final ConcurrentMap<Long, FrontendConnection> frontends;	/* 和客户端的连接 */
    private final ConcurrentMap<Long, BackendConnection> backends;		/* 和mysql的连接 */
    private final CommandCount commands;	/* 统计信息 */
    private long netInBytes;	/* 网络读的数据大小 */
    private long netOutBytes;	/* 网络写的数据大小 */
