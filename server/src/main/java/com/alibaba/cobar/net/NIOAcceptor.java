...
public final class NIOAcceptor extends Thread {
    ...
    private final ServerSocketChannel serverChannel;	/* 对应的channel */
    private final FrontendConnectionFactory factory;	/* 新建连接的工厂  */
    private NIOProcessor[] processors;	/* 处理线程 */
    private int nextProcessor;					/* 用于分配NIOProcessor */
    ...
    private void accept() {
        ...
        try {
            ...
            NIOProcessor processor = nextProcessor();	/* 将客户端的连接分配给一个NIOProcess处理 */
