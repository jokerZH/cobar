...
public final class SQLRecorder {
    ...
    private int index;				/* 当前写入的下标，当数组不满的时候有用 */
    private long minValue;		/* 最小的执行时间 */
    private final int count;	/* recoders数组的大小 */
    private final int lastIndex;	/* 下次要写的record */
    private final SQLRecord[] records;	/* 记录 */
