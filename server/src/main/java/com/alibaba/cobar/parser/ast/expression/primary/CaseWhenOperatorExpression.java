...
public class CaseWhenOperatorExpression extends PrimaryExpression {
    private final Expression comparee;	/* CASE 后面的表达式 */
    private final List<Pair<Expression, Expression>> whenList; 	/* WHEN xx THEN xx 中的表达式 */
    private final Expression elseResult;	/* ELSE xx END 中的表达式 */
