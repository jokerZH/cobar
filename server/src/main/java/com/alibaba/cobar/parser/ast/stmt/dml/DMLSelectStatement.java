...
public class DMLSelectStatement extends DMLQueryStatement {
    ...
    private final SelectOption option;	/* select选项 */
    /** string: id | `id` | 'id' */
    private final List<Pair<Expression, String>> selectExprList;	/* 字段 和 别名 */
    private final TableReferences tables;	/* 表信息 */
    private final Expression where;	/* where 表达式 */
