...
public class ServerConnection extends FrontendConnection {
    ...
    private volatile int txIsolation;			/* 隔离等级 */
    private volatile boolean autocommit;	/* 是否自动提交 */
    private volatile boolean txInterrupted;	/* 是否中断事务 TODO*/
    private long lastInsertId;	/* 上次自动分配的id */
    private BlockingSession session;		/* block session */
    private NonBlockingSession session2;	/* noblock session */
    ...
    public void heartbeat(byte[] data) {
		...
		/* 处理客户端请求的地方, type 请求的类型，如SELECT UPDATE等等 */
