 ...
 * 
 * 解析server.xml文件中的cluster部分
 */
public class ClusterConfig {
    private final Map<String/*nodeName*/, CobarNodeConfig> nodes;
    private final Map<String/*groupName*/, List<String/*nodeName*/>> groups;	/* 各个node的分组情况 */
