...
public class SchemaConfig {
    ...
    private final String name;			/* 相当于逻辑db */
    private final String dataNode;	/* 默认的dataNode */
    private final String group;
    private final Map<String, TableConfig> tables;	/* 逻辑表到物理db的映射 */
    private final boolean noSharding;	/* 是否sharding */
    private final String[] metaDataNodes;
    private final boolean keepSqlSchema;
    private final Set<String> allDataNodes;	/* 当前逻辑db涉及到的所有DataNode */
